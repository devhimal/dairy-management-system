...
function validate_supliers($f_no, $f_id, $f_name, $f_locallity, $f_ac, $f_phone, $conn)
{
    ...
    $idresult =  mysqli_query($conn, "select * from supliers where f_id= '$f_id' ") or die("unable to fetch records" . mysqli_error($conn));
    ...
    $noresult = mysqli_query($conn, "select * from supliers where f_no= '$f_no' ") or die("unable to fetch records" . mysqli_error($conn));
