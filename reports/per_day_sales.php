...
<form class="form-inline" method="post" action="">
    <div class="control-group">
        ...
        <input type="search" name="farmer" class="search-query" value="" placeholder="Suplier No"
        ...
        <tbody>
            ...
            if (isset($_REQUEST['farmer']) && $_REQUEST['farmer'] != '') {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    echo "<td style='padding: 10px; vertical-align: top;'>" . nl2br($row['r_kg']) . "</td>";
                    echo "<td style='padding: 10px; vertical-align: top;'>" . nl2br($row['r_dt']) . "</td>";
                    echo "<td style='padding: 10px; vertical-align: top;'>" . nl2br($row['r_deliverer']) . "</td>";
                    echo "</tr>";
                }
                echo "<tr><td><strong>Total</strong></td><td style='padding: 10px;'> <strong>$total</strong><td>--</td><td>--</td></tr>";
            }
            ?>
        </tbody>
    </table>
