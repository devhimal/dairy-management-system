    ...
    <div class="control-group">
        ...
        <div class="controls">
            ...
            <select class="input-xlarge" name='e_role'>
                <option <?php echo  $selected = (stripslashes($row['e_role']) == 'Clerk' ? "selected='selected'" : "");
                        echo $selected ?>>
                    Clerk</option>
                <option <?php echo  $selected = (stripslashes($row['e_role']) == 'Supervisor' ? "selected='selected'" : "");
                        echo $selected ?>>
                    Supervisor</option>
                <option <?php echo  $selected = (stripslashes($row['e_role']) == 'Manager' ? "selected='selected'" : "");
                        echo $selected ?>>
                    Manager</option>
            </select>
        </div>
